...
The current *OPALX* implementation is documented in the local Doxygen
build. The relevant pages are:

- [`src/Physics/LinearBreitWheeler.h`](/api/opalx/html/LinearBreitWheeler_8h.html)

- [`src/Physics/LinearBreitWheeler.cpp`](/api/opalx/html/LinearBreitWheeler_8cpp.html)

- [`unit_tests/Physics/TestLinearBreitWheeler.cpp`](/api/opalx/html/TestLinearBreitWheeler_8cpp.html)

- [`unit_tests/Physics/LinearBreitWheelerBenchmarkCommon.h`](/api/opalx/html/LinearBreitWheelerBenchmarkCommon_8h.html)

- [`unit_tests/Physics/LinearBreitWheelerBenchmark.cpp`](/api/opalx/html/LinearBreitWheelerBenchmark_8cpp.html)

- [`unit_tests/Physics/TestLinearBreitWheelerSpectrum.cpp`](/api/opalx/html/TestLinearBreitWheelerSpectrum_8cpp.html)

- [`gamma-gamma/generate-gamma-gamma-results.sh`](https://github.com/OPALX-project/OPALX-project.github.io/blob/master/gamma-gamma/generate-gamma-gamma-results.sh)
